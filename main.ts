...
basic.forever(function () {
    radio.sendString("3" + "/" + fixString(input.acceleration(Dimension.X)) + "/" + fixString(input.acceleration(Dimension.Y)) + "/" + fixString(input.acceleration(Dimension.Z)))
    basic.pause(5)
    radio.sendString("4" + "/" + fixString(input.magneticForce(Dimension.X)) + "/" + fixString(input.magneticForce(Dimension.Y)) + "/" + fixString(input.magneticForce(Dimension.Z)))
})
